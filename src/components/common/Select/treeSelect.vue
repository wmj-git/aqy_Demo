...
<template>
  ...
  <el-popover v-model="visible" trigger="click" placement="bottom-start">
    <div class="card-tree" style="width:200px;height:300px;overflow:auto;">
      <el-tree :data="data" node-key="id" highlight-current :props="treeProps" @node-click="handleNodeClick" />
    </div>
    <el-input slot="reference" v-model="name" :disabled="disabled" />
  </el-popover>
